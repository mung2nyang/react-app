// Step 0-4 감사 보완 4차: CarManagementPage.jsx(298줄, 200줄 제한 위반)에서 폼 모달만
// 분리했다. 로직은 한 글자도 안 바꿨다 — draft 상태와 저장 호출은 그대로 부모가 갖고,
// 여기는 렌더만 한다.
        ...
        {isSub && (
          <>
            ...
            <div className="form-group">
              ...
              <select id="newCarSettlementMode" className="input-box" value={draft.settlementMode} onChange={(e) => setDraft({ ...draft, settlementMode: e.target.value })}>

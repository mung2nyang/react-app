// Step 0-4 감사 보완 4차: ClientManagementPage.jsx(314줄, 200줄 제한 위반)에서 폼
// 모달만 분리했다. 로직은 한 글자도 안 바꿨다.
    ...
    <div className="modal-overlay" onClick={onCancel}>
      <div className="modal-content client-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="form-group">
          ...
          <select id="clientPaymentTerm" className="input-box" value={draft.paymentTerm} onChange={(e) => setDraft({ ...draft, paymentTerm: e.target.value, paymentTermValue: '' })}>
        ...
        {needsPaymentTermValue(draft.paymentTerm) && (
          <div className="form-group">
            ...
            <input id="clientPaymentTermValue" className="input-box" inputMode="numeric" placeholder="숫자 입력" value={draft.paymentTermValue} onChange={(e) => setDraft({ ...draft, paymentTermValue: e.target.value.replace(/\D/g, '') })} />
          </div>
        )}
